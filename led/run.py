...
def test():
    changeState(request.args.get('state', default = 1, type = int))
    return 'LED style changed!'

# Change led state
def changeState(_state):
    global STATE 
    STATE = _state
...
if __name__ == '__main__':
    ...
    stateThread = threading.Thread(target=led_loop)
